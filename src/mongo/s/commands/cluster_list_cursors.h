...
namespace mongo {
    ...
    /**
     * The listCursors command is used to list the currently open cursors on a MongoDB instance.
     *
     * The listCursors command takes as its argument a nested object which specifies the command to
     ...
     */
    class CmdClusterListCursors : public Command {
    public:
        CmdClusterListCursors();
